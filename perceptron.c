...
void study(Perceptron *p, double eta, double truevalue,double *input)//outtput is assumed to be of dim1
{
...
//scanf("%d",&sz );
initializeperceptron(&p1,1);//perceptron with one input
verbose(p1);
double input[]={1};
